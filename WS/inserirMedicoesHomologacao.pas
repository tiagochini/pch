...
// WSDL     : https://www.snirh.gov.br/ws-telemetria-testes/services/inserirMedicoes?wsdl
//  >Import : https://www.snirh.gov.br/ws-telemetria-testes/services/inserirMedicoes?wsdl>0
// Encoding : UTF-8
// Codegen  : [wfUseSettersAndGetters+]
// Version  : 1.0
// (2025-04-11 22:10:19 - - $Rev: 121536 $)
// ************************************************************************ //

unit inserirMedicoesHomologacao;
...
type
  ...
  // style     : document
  // use       : literal
  // binding   : DadoHidrologicoServiceImplServiceSoapBinding
  // service   : DadoHidrologicoServiceImplService
  // port      : DadoHidrologicoServiceImplPort
  // URL       : http://www.snirh.gov.br/ws-telemetria-testes/services/inserirMedicoes
  // ************************************************************************ //
  DadoHidrologicoService = interface(IInvokable)
  ['{F5A27EC1-F940-FA53-8923-BF2667A09E55}']
...
const
  defWSDL = 'https://www.snirh.gov.br/ws-telemetria-testes/services/inserirMedicoes?wsdl';
  defURL  = 'http://www.snirh.gov.br/ws-telemetria-testes/services/inserirMedicoes';
